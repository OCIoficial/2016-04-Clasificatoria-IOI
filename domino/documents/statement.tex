...
Por otro lado, para un $n$-dominó donde si es posible formar un cuadrado no necesariamente es posible armar un cuadrado $(n,k)$ para cualquier $k$.
Por ejemplo, para el $7$-dominó la suma de los lados siempre sera menor que 90, y por lo tanto no es posible formar un cuadrado $(7,90)$.
...
La subtarea 2 consiste en implementar la \verb+validar+ que dado un cuadrado debe validar que este cumple con la restricción de que todos los lados sumen lo mismo.
...
En las subtareas 3, 4 y 5, debes implementar la función \verb+construir+ que para $n$ y $k$ construye, si es posible, un cuadrado $(n,k)$, y retorna \verb+true+ si es posible o \verb+false+ si no.
\begin{itemize}
